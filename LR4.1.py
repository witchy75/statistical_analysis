...
if r >= -1 and r <= 1:
    print("свойство 1) −1 ≤ r ≤ 1 - выполняется")
else:
    print("свойство 1) −1 ≤ r ≤ 1 - не выполняется")

if r != 0:
    print("свойство 2) при r ≠ 0 величины коррелированы")
else:
    print("свойство 2) при r = 0 величины некоррелированы")
...
if data_corr_matrix.iloc[0, 1] == r:
    ...
    print("свойство 3) r не меняется от прибавления к х и у постоянных (неслучайных) слагаемых и от умножения х и у на положительные числа - не выполняется")

if r > 0:
    print("свойсвто 4) положительное значение коэффициента корреляции указывает на прямую зависимость")
else:
    print("свойсвто 4) отрицательное значение коэффициента корреляции указывает на обратную зависимость")

if 0 < abs(r) <= 0.3:
    print("свойство 5) 0 < |r| ≤ 0,3 зависимость слабая")
elif 0.3 < abs(r) <= 0.5:
    print("свойство 6) при 0,3 < |r| ≤ 0,5 зависимость умеренная")
elif 0.5 < abs(r) <= 0.7:
    print("свойство 7) при 0,5 < |r| ≤ 0,7 зависимость заметная")
elif 0.7 < abs(r) < 1:
    print("свойство 8) при 0,7 < |r| < 1 зависимость сильная")
else:
    print("свойство 9) при |r| = 1 между величинами функциональная зависимость")


print("""проверим нулевую гипотезу о значимости выборочного коэффициента корреляции:
      нулевая гипотеза H0: 𝜌xy = 0
      конкурирующая гипотеза H1: 𝜌xy ≠ 0
      """)
